...
import edu.poli.prap.gd.data.Titulo;
 ...
 */
@Stateless
@Path("edu.poli.prap.gd.data.service.titulo")
public class TituloFacadeREST extends AbstractFacade<Titulo> {
    ...
    @Path("{id}")
    @Consumes({MediaType.APPLICATION_XML, MediaType.APPLICATION_JSON})
    public void edit(@PathParam("id") Long id, Titulo entity) {
        super.edit(entity);
    }
    ...
    public Titulo find(@PathParam("id") Long id) {
